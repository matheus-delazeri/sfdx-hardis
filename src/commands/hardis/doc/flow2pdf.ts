...
export default class Flow2Markdown extends SfCommand<any> {
  public static title = 'Flow to PDF';

  public static description = `Generates a Markdown and PDF documentation from a Flow file
...
If [AI integration](${CONSTANTS.DOC_URL_ROOT}/salesforce-ai-setup/) is configured, documentation will contain a summary of the Flow.  
  ...
  public static examples = [
    '$ sf hardis:doc:flow2pdf',
    '$ sf hardis:doc:flow2pdf --inputfile force-app/main/default/flows/MyFlow.flow-meta.xml'
  ];
  ...
  public static flags: any = {
    ...
    outputfile: Flags.string({
      char: 'f',
      description: 'Force the path and name of output markdown file. Must end with .pdf',
    }),
  ...
  public async run(): Promise<AnyJson> {
    ...
    const gen2res = await generateMarkdownFileWithMermaid(this.outputFile, this.outputFile, ['cli']);
    if (!gen2res) {
